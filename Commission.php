...
function openSettingNav() {
    ...
    document.getElementById("commission").style.background = "#ddd";
...
function closeSettingNav() {
    ...
    document.getElementById("commission").style.background = "black";
}
...
<script>
  ...
  function createChart() {
            $("#commission_bar_chart").kendoChart({
                ...
                categoryAxis: {
                    ...
                    categories: ["Forcast","Personal Goal","Corporate Goal"],
                   line: {
                        visible: true
                    },
                    majorGridLines: {
    ...
    <div class="accordionItem">
      ...
      <div>
        <p>Click To Syn</p>
              ...
              <p style="color: white;float: right;padding-right: 110px;margin-bottom: 0px;margin-top: 4px;"> Commissions</p>
              </div>
            ...
            <li><a href="#" >Commission<span></span></a>
...
<div id="tabstrip" style="background:white;border:none;">
        <ul style="float: right;">
          <li class="k-state-active">Monthly</li>
          <li>Quarter</li>
          <li>Year</li>
        </ul>
...
<u>Month Of December 2016</u>

<div class="chart-wrapper" id="commission_bar_chart"></div>
</div>
...
// ]]></script>
  ...
  <img src="images/home.png" alt="Home" width="30" height="30">
        ...
        <li><a href="#" style="background-color: black" id="commission"><img src="images/commission.png" alt="Home" width="30" height="30"></a></li>
